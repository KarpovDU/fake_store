...
import type { Product, ProductsByCategoryQuery, ProductsQuery, ProductsResponse, ProductsSearchQuery } from "../types"
...
export const productApi = createApi({
  ...
  endpoints: builder => ({
    ...
    getSingleProductById: builder.query<Product, number>({
      query: number => `/${number}`,
    }),
  }),
})
